...
public class CompanyServiceImpl implements CompanyService {
  ...
  public void updateCompanyNameById(Long id, String companyName){
    Stock stock = stockRepository.findById(id).orElseThrow(()-> new EntityNotFoundException("Entity not found"));
  ...
  public Stock getStocks(Long id){
    return stockRepository.findById(id).orElseThrow(()-> new EntityNotFoundException("Entity not found"));
  }

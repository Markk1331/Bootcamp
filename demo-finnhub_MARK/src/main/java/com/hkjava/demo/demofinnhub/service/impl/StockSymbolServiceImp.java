...
@Service
public class StockSymbolServiceImp implements StockSymbolService {
  ...
  public List<Symbol> getAllSymbols() throws FinnhubException {
    ...
    .scheme(Protocol.HTTPS.name()).host(domain).pathSegment(baseUrl) //
    .path(symbolEndpoint).queryParam("exchange", "US")
